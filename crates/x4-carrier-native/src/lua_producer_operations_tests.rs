...
unsafe extern "C" fn push_integer(state: *mut core::ffi::c_void, value: isize) {
...
unsafe extern "C" fn to_string(
    ...
    unsafe { *length = state.token.len() };
    state.token.as_ptr().cast()
}
unsafe extern "C" fn lua_type(_: *mut core::ffi::c_void, index: i32) -> i32 {
    i32::from(index == 1) * 4
}
unsafe extern "C" fn noop_table(_: *mut core::ffi::c_void, _: i32, _: i32) {}
unsafe extern "C" fn noop_closure(
    _: *mut core::ffi::c_void,
    _: Option<crate::abi_windows::LuaFn>,
    _: i32,
) {
}
unsafe extern "C" fn noop_string(_: *mut core::ffi::c_void, _: *const core::ffi::c_char, _: usize) {
}
unsafe extern "C" fn noop_field(_: *mut core::ffi::c_void, _: i32, _: *const core::ffi::c_char) {}
unsafe extern "C" fn noop_integer(_: *mut core::ffi::c_void, _: i32) -> isize {
    0
}
unsafe extern "C" fn noop_int(_: *mut core::ffi::c_void) -> i32 {
    0
}
unsafe extern "C" fn noop_index_int(_: *mut core::ffi::c_void, _: i32) -> i32 {
    0
}
unsafe extern "C" fn noop_state(_: *mut core::ffi::c_void) {}
unsafe extern "C" fn noop_index(_: *mut core::ffi::c_void, _: i32) {}
unsafe extern "C" fn noop_number(_: *mut core::ffi::c_void, _: i32) -> f64 {
    0.0
}
