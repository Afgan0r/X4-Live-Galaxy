...
try {
    ...
    if ($Suite -ne 'xml') {
        ...
        $files = switch ($Suite) {
            ...
            'ship_detail' { 'ship_detail_contract.lua'; 'heavy_profile_contract.lua' }
            ...
            default { 'component_discovery_contract.lua'; 'telemetry_spec.lua'; 'carrier_b_contract.lua'; 'x4_loader_contract.lua'; 'ship_collection_contract.lua'; 'ship_detail_contract.lua'; 'heavy_profile_contract.lua' }
        }
