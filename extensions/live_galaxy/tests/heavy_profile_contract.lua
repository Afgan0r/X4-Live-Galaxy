...
describe("shared heavy profile and bounded game work", function()
    ...
    it("refuses frozen/backward clocks and charges a synchronous overrun only after return", function()
        ...
        assert.is_nil(ok); assert.equals("callback_budget_exceeded", reason); assert.equals(1, entered)
